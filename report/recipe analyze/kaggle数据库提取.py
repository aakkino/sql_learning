...
file_path = "Receipes from around the world.csv"
...
df = kagglehub.load_dataset(
  ...
  "prajwaldongre/collection-of-recipes-around-the-world",
  file_path,
...
output_file_path = os.path.join(current_dir, "recipes_data.csv")
